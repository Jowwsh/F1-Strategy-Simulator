...
MEDIUM = TyreCompound("Medium", lap_time_multiplier=1.003, wear_rate=0.024, curve_rate=2.2, fuel_multiplier=1.00, warmup_penalty=[2, 0.5], stint_decay_laps=8, lap_time_sigma=0.075)
HARD = TyreCompound("Hard", lap_time_multiplier=1.005, wear_rate=0.018, curve_rate=1.7, fuel_multiplier=0.99, warmup_penalty=[2.5, 1.2, 0.3], stint_decay_laps=10, lap_time_sigma=0.05)
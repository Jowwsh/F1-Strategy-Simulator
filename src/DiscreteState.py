class DiscreteState:
    ...
    def __init__(self, lap, tyre_compound_id, wear_bin, fuel_bin, stint_lap_bin, safety_car_flag, allowed_pit_strategy, continuous_wear, continuous_fuel, real_stint_lap, is_final_lap):
        self.lap = lap
        ...
        self.is_final_lap = is_final_lap

    def state_to_tuple(self):
        return (self.tyre_compound_id, self.wear_bin, self.fuel_bin, self.stint_lap_bin, self.safety_car_flag, self.is_final_lap)
